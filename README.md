...
The default threshold is `EDGE_THRESHOLD=0.06` (6 percentage points). Treat this as a research alert, not a trade instruction. Before trading, account for spread, liquidity, slippage, fees, market resolution wording, and legal restrictions.
